...
|plot_train_valid_acc| model_name, X_train, y_train, X_test, y_test, param_name, param_vec | a plot | Takes in a model name, train/validation data sets, a parameter name and a vector of parameter values to try and then plots train/validation accuracies vs. parameter values.|
